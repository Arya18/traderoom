				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						<div class="box-header">
							<h3 class="box-title">
								Update Purchase Invoice Balance &nbsp &nbsp &nbsp <b>Final
						...
						<form role="form" id="updatePurchaseinvoiceForm"
							action="/dashboard/update-purchaseInvoice/${purchaseInvoiceId}"
							method="post">
							...
							<div class="box-footer">
								<button class="btn btn-primary" type="submit"
									id="updatePurchaseinvoiceButton" value="Submit">Submit</button>
							</div>
						</form>
					</div>
					<!-- /.box -->
